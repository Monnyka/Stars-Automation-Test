...
//TODO Reward peer......................................................................................................
    ...
    public void rewardStars_TCRS00(){
        login("leon.pa@mailinator.com","Stars@2019",true);
    }
    ...
    public void rewardStars_TCRS04(){
        ...
        Assert.assertEquals(getText("com.android.permissioncontroller:id/permission_message"),"Allow STARS to access photos and media on your device?");
        clickById("com.android.permissioncontroller:id/permission_allow_button");
...
//        }
    ...
    public void rewardStars_TCRS16_3() throws InterruptedException {
        ...
        Thread.sleep(3000);
        checkProgressValue();
        sendKeyById("com.pathmazing.stars:id/edit_text_point","5");
    }
    ...
    public void rewardStars_TCRS16_5(){
        ...
        Assert.assertEquals(getText("com.pathmazing.stars:id/textViewRewardQuantity"), "5");
    ...
    public void rewardStars_TCRS17(){
        ...
        clickById("android:id/button1");
        int allocated = Integer.parseInt(readExcelFile(18,1,"userData")) - 5;
    ...
    public void rewardStars_TCRS18() throws InterruptedException {
        ...
        //validate Screen
        Assert.assertEquals(getText("com.pathmazing.stars:id/tv_earn_point_this_month"),"5");
...
//        Assert.assertEquals(getText("com.pathmazing.stars:id/text_view_month_approved_by"), getTimeAMPM());
        ...
        Assert.assertEquals(getTextByXpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup[2]/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.TextView[1]"),
                "Leon Pin rewards 5 stars to Alvin Meta.");
        driver.navigate().back();
        logout();
    }
    ...
    public void rewardStars_TCRS23(){
        ...
        //Check reward Point
        Assert.assertEquals(getText("com.pathmazing.stars:id/tvRewardedPoint"), "5");
    ...
    public void rewardStars_TCRS25(){
        ...
        Assert.assertEquals(getText("com.pathmazing.stars:id/text_view_star"),"5");
        //Check Sender name
        Assert.assertEquals(getText("com.pathmazing.stars:id/text_view_name_sender"), "Leon Pin");
        //Position
...
//TODO: Reward Superior without Manager...................................................................................
    ...
    //Login as Sender
        login("leon.pa@mailinator.com","Stars@02019",false);
    }

    @Test
    public void rewardStars_TCRS28() throws InterruptedException {
    //Login as Sender
    ...
    //Check Screen
        ...
        //Change Stars from suggestion to 5
        sendKeyById("com.pathmazing.stars:id/edit_text_point","5");
        //Enter Reason
        sendKeyById("com.pathmazing.stars:id/edit_text_reason", readExcelFile(9,1, "rewardStaff") + readExcelFile(10,1,"rewardStaff"));
    ...
    //Submit the request
        ...
        Assert.assertEquals(getText("android:id/message"), "You have successfully rewarded 5 stars to Oliver Sovann");
        //Click on button OK
        clickById("android:id/button1");
    ...
    //Check automatically approve
        ...
        Assert.assertEquals(getTextByXpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup[2]/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.TextView[1]"),
                "You reward 5 stars to Oliver Sovann.");
        //Click on item list
        clickXpathElement("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup[2]/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[1]/android.widget.LinearLayout");
...
//TODO: Reward Superior with Manager...................................................................................
    ...
    //Check Screen
        //Check Name
        Assert.assertEquals(getText("com.pathmazing.stars:id/tvName"), "Samantha Sam");
        //Check Position
        Assert.assertEquals(getText("com.pathmazing.stars:id/tvPosition"), "Project Manager");
        //Enter Suggest Categories
        clickById("com.pathmazing.stars:id/edit_text_category");
    ...
    //Approve by manager
        clickById("com.pathmazing.stars:id/image_view_notification");
        //Check Notification list title
        Assert.assertEquals(getTextByXpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup[2]/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.TextView[1]"),
                "Leon Pin requests to reward 5 stars to Samantha Sam.");
        //Tap on the request reward
        clickXpathElement("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup[2]/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout/android.widget.LinearLayout");
    }

    @Test
    public void rewardStars_TCRS39() throws InterruptedException {
    //Approve Request
        //Stars Reward
        Assert.assertEquals(getText("com.pathmazing.stars:id/tv_earn_point_this_month"), "5");
        //Sender name
        ...
        Assert.assertEquals(getText("com.pathmazing.stars:id/text_view_name_sender_position"),"QA Tester");
        //Receiver Name
        Assert.assertEquals(getText("com.pathmazing.stars:id/text_view_project_name_receiver"), "Samantha Sam");
        //Receiver position
        Assert.assertEquals(getText("com.pathmazing.stars:id/text_view_project_name_receiver_position"),"Project Manager");
        //Reward Reason
        Assert.assertEquals(getText("com.pathmazing.stars:id/text_view_reason"),
        ...
        Assert.assertEquals(getText("android:id/message"),
        ...
        scroll(200,200,1000,200);
        Thread.sleep(1000);
        //Tap on Back button
        clickBtnBack();
        //Check notification Approve
        Assert.assertEquals(getTextByXpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup[2]/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.TextView[1]"),
                "Leon Pin rewards 5 stars to Samantha Sam.");
        //Back to Main Screen
        clickBtnBack();
        //Logout
        logout();
    ...
    @Test
    public void rewardStars_TCRS40(){
    //Check Approve
        //Log in as Sender
        login("leon.pa@mailinator.com", "Stars@2019", false);
        //Check name
        Assert.assertEquals(getText("com.pathmazing.stars:id/tvRewardedName"), "Samantha Sam");
        //Check position
        Assert.assertEquals(getText("com.pathmazing.stars:id/tvRewardedPosition"),"Project Manager");
        //Check Start to reward
        Assert.assertEquals(getText("com.pathmazing.stars:id/tvRewardedPoint"), "5");
        //Check reward Categories
        Assert.assertEquals(getText("com.pathmazing.stars:id/tv_category"), "Effort: Very Good");
        //Check Reason
        Assert.assertEquals(getText("com.pathmazing.stars:id/tv_reason"),
                "\"" + readExcelFile(9,1,"rewardStaff") + readExcelFile(10,1,"rewardStaff") + "\"");
        //Tap on Done Button
        clickById("com.pathmazing.stars:id/btnDone");
        //Success Reward
...
//TODO: Reward Subordinate..............................................................................................

    @Test
    public void rewardStars_TCRS41(){
    //select User
        //Tap on Stars icon main screen
        clickById("com.pathmazing.stars:id/image_view_star_reward");
        //Tap on staff reward icon
        ...
        sendKeyById("com.pathmazing.stars:id/tvSearchEmployee", "David");
        //Tap on searching user
        clickXpathElement("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.RelativeLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.view.ViewGroup[2]/androidx.recyclerview.widget.RecyclerView/android.widget.RelativeLayout/android.widget.LinearLayout[3]/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.RelativeLayout");
        //Check Selected User Name
        Assert.assertEquals(getText("com.pathmazing.stars:id/tvName"), "David Kong");
        //Check Position
        Assert.assertEquals(getText("com.pathmazing.stars:id/tvPosition"), "Data Entry");
        //Enter Suggest Categories
        clickById("com.pathmazing.stars:id/edit_text_category");
        //Choose Suggestion Categories
        clickXpathElement("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[2]/android.widget.RelativeLayout/android.view.View");
    ...
    @Test
    public void rewardStars_TCRS42(){
    //Submit the request
        //Check name on pop up confirm
        Assert.assertEquals(getText("com.pathmazing.stars:id/textViewVipName"), "David Kong");
        //Check position
        Assert.assertEquals(getText("com.pathmazing.stars:id/textViewVipPosition"), "Data Entry");
        //Check Stars Reward
        Assert.assertEquals(getText("com.pathmazing.stars:id/textViewRewardQuantity"), " 5");
        //Tab submit button on confirmed pop up
        clickById("com.pathmazing.stars:id/button_ok_label");
    ...
    @Test
    public void rewardStars_TCRS43() throws InterruptedException {
        //Login as manager of sender
        login("ethan.pa@mailinator.com","Stars@2019",false);
        //Tap on notification
        clickById("com.pathmazing.stars:id/image_view_notification");
        //Check the notification title
        Assert.assertEquals(getTextByXpath( "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup[2]/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.TextView[1]"),"Leon Pin requests to reward 5 stars to David Kong.");
        //Tap on notification
        clickXpathElement("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup[2]/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout/android.widget.LinearLayout");
        //Sender name
        Assert.assertEquals(getText("com.pathmazing.stars:id/text_view_name_sender"), "Leon Pin");
        ...
        Assert.assertEquals(getText("com.pathmazing.stars:id/text_view_name_sender_position"), "QA Tester");
        //Receiver name
        Assert.assertEquals(getText("com.pathmazing.stars:id/text_view_project_name_receiver"), "David Kong");
        //Receiver position
        Assert.assertEquals(getText("com.pathmazing.stars:id/text_view_project_name_receiver_position"), "Data Entry");
        //Categories
        Assert.assertEquals(getText("com.pathmazing.stars:id/text_view_category"), "Effort: Very Good");
        //Reason
        Assert.assertEquals (getText("com.pathmazing.stars:id/text_view_reason"), "\""+readExcelFile(9,1, "rewardStaff") + readExcelFile(10,1,"rewardStaff")+"\"");
        ...
        driver.navigate().back();
        //Check title notification
        Assert.assertEquals(getTextByXpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup[2]/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.TextView[1]"),
                "Leon Pin rewards 5 stars to David Kong.");
        //Tap on back button
        clickBtnBack();
        //Logout
        logout();
    ...
    @Test
    public void rewardStars_TCRS44(){
        //Check Approve by manager
        //Log in as Sender
        login("leon.pa@mailinator.com", "Stars@2019", false);
        //Check name
        Assert.assertEquals(getText("com.pathmazing.stars:id/tvRewardedName"), "David Kong");
        //Check position
        Assert.assertEquals(getText("com.pathmazing.stars:id/tvRewardedPosition"),"Data Entry");
        //Check Start to reward
        Assert.assertEquals(getText("com.pathmazing.stars:id/tvRewardedPoint"), "5");
        //Check reward Categories
        Assert.assertEquals(getText("com.pathmazing.stars:id/tv_category"), "Effort: Very Good");
